package ir.tehranluster.paano.service.user;

import ir.tehranluster.paano.dao.addres.AddresDao;
import ir.tehranluster.paano.dao.user.UserDao;
import ir.tehranluster.paano.dao.user.UserDetailDao;
...
public class UserServiceImpl implements UserService{
    ...
    public UserDto findUserById(Long id) {
       ...
       userDto.setMobile((String) userDtoValue[0]);
    ...
    public UserDto findUserByMobile(String mobile) {
      UserDto userDto = new UserDto();
      Optional<User> user = userDao.findUserByMobile(mobile);
      if(user.isPresent()){
